...
class MISSL(pl.LightningModule):
    def __init__(self,
                 ...
                 inter_intent_lambda: float = 0.05, intra_intent_lambda: float = 0.05, weight: float = 0.6, intent_enhance: bool = True,
        ...
        self.weight = weight
        self.intent_enhance = intent_enhance
    ...
    def forward(self, item_seq, type_seq):
        ...
        if self.intent_enhance:
            ...
            item_emb_output, type_emb_output = self.trm_encoder(graph_item_output, input_emb_type, extended_attention_mask, type_seq)
            ...
            return item_emb_output, type_emb_output